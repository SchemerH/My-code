...
namespace _8
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = string.Format ("insert into student (姓名,性别,年级) values ('{0}','{1}','{2}')",name,sex,grade);
            
            string connstring = "Data Source=DESKTOP-781JML6;Initial Catalog=sql;Integrated Security=True";
            SqlConnection connection1 = new SqlConnection(connstring); 
